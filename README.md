# Awesome Swift Playgrounds with stars
...
* [MPCS51032 UChicago iOS Course](https://github.com/uchicago-mobi/mcps51032-2017-spring-playground) ⭐ 7 | 🐛 0 | 🌐 Swift | 📅 2017-07-11 - Playgrounds from the 2017 Spring iOS course of the University of Chicago.
...
* [Swift Memory Management](https://github.com/ndethore/swift-memory-management) ⭐ 3 | 🐛 0 | 🌐 Swift | 📅 2016-01-22 - How to avoid retain cycles, from [this post](http://detho.re/2016/01/21/writing-memory-efficient-swift-code/). ⏳
...
* [Swift Diagram Playgrounds](https://github.com/alskipp/Swift-Diagram-Playgrounds) ⭐ 277 | 🐛 1 | 🌐 Swift | 📅 2016-09-20 - Adaptation of the Protocol-Oriented Programming in Swift talk from WWDC 2015.
* [Swift Protocol Extensions](https://github.com/davidahouse/SwiftProtocolExtensions) ⚠️ Archived - A playground to explore Protocol Extensions. ⏳
* [Battleship Example](https://github.com/vichudson1/Battleship-POP-Example) ⭐ 13 | 🐛 0 | 🌐 Swift | 📅 2018-02-24 - An example of how to use Protocol Oriented Programming with the battleship game. ⏳

### Functional Reactive Programming

* [ReactiveCocoa Playground](https://github.com/nikita-leonov/ReactiveCocoaPlayground) ⭐ 97 | 🐛 2 | 🌐 Swift | 📅 2018-02-12 - The easiest way to get a taste of ReactiveCocoa. ⏳
* [Swift Reactive Playground](https://github.com/ColinEberhardt/SwiftReactivePlayground) ⭐ 27 | 🐛 0 | 🌐 Swift | 📅 2014-09-03 - Companion to the article: ReactiveCocoa made Simple With Swift. ⏳
...
* [XCTest Playground](https://github.com/Liquidsoul/XCTestPlayground) ⭐ 54 | 🐛 0 | 🌐 Swift | 📅 2017-11-05 - Better looking tests for playgrounds.
* [Interactive Playground](https://github.com/dasdom/InteractivePlayground) ⭐ 53 | 🐛 0 | 🌐 Swift | 📅 2016-12-07 - Exploring interactivity in Playgrounds.
* [Mondrian](https://github.com/timbellay/Mondrian) ⭐ 4 | 🐛 0 | 🌐 Swift | 📅 2016-01-24 - Make iOS app mockups in Swift 2.x playgrounds. ⏳
...
* [Swift Algorithm Club](https://github.com/raywenderlich/swift-algorithm-club) ⭐ 29,089 | 🐛 62 | 🌐 Swift | 📅 2024-12-06 - Algorithms and data structures in Swift with explanations. 🌟
...
* [Swiftography](https://github.com/sketchytech/Swiftography) ⭐ 8 | 🐛 0 | 🌐 Swift | 📅 2017-11-10 - Standard cryptographic algorithms in a Swift Playground. ⏳
* [Algorithms Playground](https://github.com/ashokgelal/AlgorithmsPlayground) ⭐ 6 | 🐛 0 | 🌐 Swift | 📅 2015-06-03 - Various algorithm implementation in Swift. ⏳
* [The Jelly Bean Problem](https://github.com/kyleweiner/Jelly-Bean-Problem) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2016-03-10 - The Jelly Bean problem from Wait But Why. ⏳
* [Euclidean Strings](https://github.com/modulusMathews/ReEuclid) ⭐ 1 | 🐛 0 | 🌐 Swift | 📅 2016-03-29 - A playground leveraging ReSwift to generate Euclidean Strings. ⏳
...
* [Emoji Intelligence](https://github.com/BilalReffas/EmojiIntelligence) ⭐ 1,424 | 🐛 0 | 🌐 Swift | 📅 2018-08-21 - Neural Network built in Apple Playground using Swift. 🌟
...
* [CoreImage for Swift Playgrounds](https://github.com/FlexMonkey/CoreImageForSwiftPlaygrounds) ⭐ 88 | 🐛 0 | 🌐 Swift | 📅 2017-06-07 - Growing collection of CoreImage playgrounds from the upcoming book "CoreImage For Swift". 🌟 ⏳
* [Interpolation Playground](https://github.com/FlexMonkey/Interpolation-Playground-) ⭐ 63 | 🐛 0 | 🌐 Swift | 📅 2020-01-27 - Playground demonstrating lerp, smooth step, Catcall-Rom and others! ⏳
* [Image Processor](https://github.com/mortenbrudvik/ImageProcessor) ⭐ 9 | 🐛 0 | 🌐 Swift | 📅 2020-12-23 - Implementing different image filter algorithms. ⏳
...
* [Core Animation Timing](https://github.com/Kentzo/CoreAnimationTiming) ⭐ 1 | 🐛 1 | 🌐 Swift | 📅 2020-01-23 - Playground demonstrating effects of CAMediaTiming properties. 🍁
...
* [Miles](https://github.com/lalomts/Miles) ⭐ 35 | 🐛 0 | 🌐 Swift | 📅 2020-04-16 - A Swift Playground that creates jazz improvisations in any key using AudioToolbox and AVFoundation.
* [Rhythm Snap](https://github.com/carlosmbe/Rhythm-Snap) ⭐ 9 | 🐛 0 | 🌐 Swift | 📅 2023-05-22 - A Swift Playground using Vision and AVFoundation to help you practice rhythm in a fun way.🍁
* [PlayerNode Playground](https://github.com/genedelisa/PlayerNodePlayground) ⭐ 5 | 🐛 0 | 🌐 Swift | 📅 2019-12-24 - Playground using AVAudioEngine with a playernode and effects to play an audio file. 🌟
* [Bach Playground](https://github.com/dreamwieber/BachPlayground) ⭐ 4 | 🐛 0 | 🌐 Swift | 📅 2016-10-31 - A Simple Swift Playground that plays a brief piece by Bach with AVAudioEngine and AVMIDIPlayer.
...
* [Polydoxical](https://github.com/kirkbyo/Polydoxical) ⭐ 0 | 🐛 0 | 🌐 Swift | 📅 2017-04-22 - Interactive playground to experiment with roulettes and polygons.
...
* [AIToolbox](https://github.com/KevinCoble/AIToolbox/tree/master/Playgrounds) ⭐ 805 | 🐛 6 | 🌐 Swift | 📅 2020-08-09 - A set of playgrounds showing machine learning algorithms, all implemented with pieces of the AIToolbox framework code.
...
* [Mgrebenets's Playgrounds](https://github.com/mgrebenets/playgrounds) ⭐ 9 | 🐛 0 | 🌐 Swift | 📅 2018-02-05 - Various playgrounds.c 🌟
* [Swift fun playgrounds](https://github.com/madbat/Swift-fun-playgrounds) ⭐ 8 | 🐛 0 | 🌐 Swift | 📅 2015-03-17 - A few playgrounds to showcase Swift peculiar features. ⏳
* [Sketchytech's Playgrounds](https://github.com/sketchytech/SwiftPlaygrounds) ⭐ 7 | 🐛 0 | 🌐 Swift | 📅 2015-07-07 - Various Playgrounds. 🌟 ⏳
* [Uberbruns's Playgrounds](https://github.com/uberbruns/SwiftPlaygrounds) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2023-08-22 - Various playgrounds. ⏳
* [Cananito's Playgrounds](https://github.com/Cananito/Playgrounds) ⭐ 2 | 🐛 0 | 🌐 Swift | 📅 2017-08-07 - Various playgrounds. ⏳
...
* [Game Boards](https://github.com/joalbright/Gameboard) ⭐ 182 | 🐛 0 | 🌐 Swift | 📅 2026-08-10 - Chess, checkers, tic-tac-toe, sudoku and many others in playground. 🌟 ⏳
...
* [Super Maze](https://github.com/W00dL3cs/Super-Maze) ⭐ 9 | 🐛 0 | 🌐 Swift | 📅 2017-04-03 - A programmatic maze generator and solver.
* [Tic Tac Toe](https://github.com/aabosh/Tic-Tac-Toe) ⭐ 8 | 🐛 0 | 🌐 Swift | 📅 2017-04-16 - Tic tac toe in a playground.
* [Earth photos](https://github.com/jtbandes/DSCOVR.playground) ⭐ 6 | 🐛 0 | 🌐 Swift | 📅 2021-09-10 - A slideshow of Earth photos taken by DSCOVR/EPIC. 🌟 ⏳
* [LaunchPad Playground](https://github.com/Juniorlimaivd/LaunchPad-Playground) ⭐ 5 | 🐛 0 | 🌐 Swift | 📅 2018-04-17 - A playground that simulates a real LaunchPad for making music.
* [StarWars Seals](https://github.com/jeremyconkin/StarWarsSeals) ⭐ 3 | 🐛 0 | 🌐 Swift | 📅 2018-05-20 - Emblems from Star Wars in Swift playgrounds via CoreGraphics and UIViews. ⏳
